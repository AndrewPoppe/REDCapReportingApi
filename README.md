...
| `enabled_external_modules` | The external modules enabled for the project, formatted as a semicolon-delimited string. The value is the directory prefix of the module, as listed in the `redcap_external_modules` table. | N/A                                                                                                            | module1;module2                |
